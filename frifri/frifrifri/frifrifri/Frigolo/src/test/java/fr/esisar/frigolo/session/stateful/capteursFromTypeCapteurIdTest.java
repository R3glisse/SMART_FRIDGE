...
public class capteursFromTypeCapteurIdTest {

    private static final Logger log = Logger.getLogger(capteursFromTypeCapteurIdTest.class.getName());
    ...
    public void testcapteursFromFrigidaireId() throws Exception {
        ...
        Admin.capteursFromTypeCapteurId();
