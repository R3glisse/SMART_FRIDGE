...
public class getUniteFromMesureIdTest {

    private static final Logger log = Logger.getLogger(getUniteFromMesureIdTest.class.getName());
    ...
    public static Archive createTestArchive() {
        return ShrinkWrap.create(WebArchive.class, "testgetUniteFromMesureIdCont.war")
    ...
    @Test
    public void testgetUniteFromMesureId() throws Exception {
        ...
        List<MesureNumeriqueEJBEntity> TestMesNum = MesNumEJB.findMesuresNumeriques();

        Admin.setMesureId(TestMesNum.get(0).getIdMesure());
        Assert.assertFalse(TestMesNum.isEmpty());

        String TestGetUnitFromMesID = Admin.getUniteFromMesureId();
        log.info("\n\n\nTest Unit is : " + TestGetUnitFromMesID + "\n\n\n");

        log.info("\n\n\nTest getUniteFromMesureId() is Validated\n\n\n");
