...
public class getAllUnitesTest {

    private static final Logger log = Logger.getLogger(getAllUnitesTest.class.getName());
    ...
    public static Archive createTestArchive() {
        return ShrinkWrap.create(WebArchive.class, "testgetAllUnitesCont.war")
