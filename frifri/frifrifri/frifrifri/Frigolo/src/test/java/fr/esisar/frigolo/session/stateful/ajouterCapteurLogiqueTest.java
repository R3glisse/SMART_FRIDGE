...
public class ajouterCapteurLogiqueTest {

    private static final Logger log = Logger.getLogger(ajouterCapteurLogiqueTest.class.getName());
    ...
    public static Archive createTestArchive() {
        return ShrinkWrap.create(WebArchive.class, "testajouterCapteurLogiqueCont.war")
    ...
    public void testgetAllUnites() throws Exception {
        ...
        List<CapteurLogiqueEJBEntity> TestCaptLog = CaptLogEJB.findCapteursLogiques();
        Assert.assertFalse(TestCaptLog.isEmpty());
        log.info("\n\n\nTest ajouterCapteurLogique() is functional\n\n\n");

        Long IdCapteurLog = TestCaptLog.get(0).getIdCapteur();
        Admin.setCapteurLogiqueId(IdCapteurLog);
        Admin.suppressionCapteurLogique();

        TestCaptLog = CaptLogEJB.findCapteursLogiques();
        Assert.assertTrue(TestCaptLog.isEmpty());
        log.info("\n\n\nTest suppressionCapteurLogique() is functional\n\n\n");
